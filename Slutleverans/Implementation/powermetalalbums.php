...
<Header id="header">
    ...
    $albumid = $_REQUEST['albumid'];
            ...
            echo '<h2 id="container">','Glory to the brave grades','</h2>';
    ...
    try {
    	    ...
    	    $result = $db->executeQuery()->getResultArray();
    	        foreach ($result as $name) {
    	            if($name['name'] == "Glory to the brave")
    	        ...
    	        foreach ($result as $contents) {
                     if($contents['name'] == "Glory to the brave")
                     {
    	        ...
    	        foreach ($result as $persons) {
                    if($persons['name'] == "Glory to the brave")
                    {
        ...
        echo '<a id="container" href="http://cdon.se/musik/hammerfall/glory_to_the_brave_reloaded-22930141">',"Buy Glory to the brave album",'</a>','<br>';
        echo '<a id="container" href="creategrades.php">',"Set a grade on album",'</a>','<br>';
        echo '<a id="container" href="deletegrade.php">',"Delete grade",'</a>';
?>
