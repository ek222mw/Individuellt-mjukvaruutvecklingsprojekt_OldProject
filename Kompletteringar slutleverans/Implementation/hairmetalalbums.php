...
<Header id="header">
    ...
    $albumid = $_REQUEST['albumid'];
            ...
            echo '<h2 id="container">','Hardcore superstar grades','</h2>';
    ...
    try {
    	    ...
    	    $result = $db->executeQuery()->getResultArray();
    	        ...
    	        foreach ($result as $contents) {
                     if($contents['name'] == "Hardcore superstar")
                     {
    	        ...
    	        foreach ($result as $persons) {
                    if($persons['name'] == "Hardcore superstar")
                    {
        ...
        echo '<br>';
        echo '<a id="container" href="http://cdon.se/musik/hardcore_superstar/hardcore_superstar-520377">',"Buy Hardcore superstar album",'</a>','<br>';
