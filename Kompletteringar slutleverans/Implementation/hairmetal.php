...
require_once "orm.php";
    ...
    try {
    	    ...
    	    foreach ($result as $name) {
                    if ($name['name'] == "Hardcore Superstar" )
                    {
                         echo '<h2 id="container">',$name['name'],'</h2>';
                         echo '<div id="container">','<img height="200" width="300" src="Pics/hardcore.jpg" alt="Hardcore Superstar" title="Hardcore Superstar" />','</div>','<br>';
    	        ...
    	        foreach ($result as $biography) {
                    if ($biography['name'] == "Hardcore Superstar") 
                    {
    	     ...
    	     foreach ($result as $discography) {
                    if ($discography['name'] == "Hardcore Superstar") 
                    {
        ...
        echo '<div id="container">','<a href="hairmetalalbums.php"  title="View Hair Metal albums">','<img  src="Pics/bandlink.jpg"  />','View Hair Metal albums','</a>','</div>';
