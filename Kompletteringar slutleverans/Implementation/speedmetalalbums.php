...
<html lang="sv">
   <head>
       <meta http-equiv="content-type" content="text/html" charset="ISO-8859-1" initial-scale=1.0 maximum-scale=1.0 user-scalable=0 />
        <title>Speed Metal Albums</title>
...
<Header id="header">
    ...
    $albumid = $_REQUEST['albumid'];
            ...
            echo '<h2 id="container">','Diamonds grades','</h2>';
...
require_once "orm.php";
    ...
    try {
        ...
        echo '<a id="container" href="http://cdon.se/musik/enforcer/diamonds-9089826">',"Buy Diamonds album",'</a>','<br>';
