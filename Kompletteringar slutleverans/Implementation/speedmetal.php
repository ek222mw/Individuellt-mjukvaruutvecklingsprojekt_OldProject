...
require_once "orm.php";
    ...
    try {
    	    ...
    	    foreach ($result as $name) {
                    if ($name['name'] == "Enforcer" )
                    {
                         echo '<h2 id="container">',$name['name'],'</h2>';
                         echo '<div id="container">','<img height="200" width="300" src="Pics/enforcer.jpg" alt="Enforcer" title="Enforcer" />','</div>','<br>';
        ...
        echo '<div id="container">','<a href="speedmetalalbums.php"  title="View Speed Metal albums">','<img  src="Pics/bandlink.jpg" alt="Enforcer" title="Enforcer" />','View Speed Metal albums','</a>','</div>';
